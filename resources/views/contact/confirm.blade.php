        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <form method="post" action="{{ route('contact.send') }}">
                    ...
                    <input name="back" type="submit" value="戻る" class="btn btn-block bg-white btn-outline-secondary text-decoration-none text-secondary mt-4" /> --}}
{{--
                    <label>お名前</label>
                    {{ $inputs['name'] }}
                    <input name="name" value="{{ $inputs['name'] }}" type="hidden">
                    ...
                    <button type="submit" name="action" value="back" class="btn btn-block btn-teal1 mt-4">
                        入力内容修正
                    </button>
