        ...
        @if ($achievement == 'success')
            ...
            <form method="POST" action="{{ route('achievement.update', ['article' => $article]) }}">
                ...
                <div class="form-body">
                    ...
                    <label>反省・学び</label>
                    <textarea name="study" class="form-control my-2" rows="2" placeholder="反省"></textarea>
                    <label>次回の意気込み</label>
                    <textarea name="enthusiasm" class="form-control my-2" rows="2" placeholder="意気込み"></textarea>
        ...
        @elseif ($achievement == 'failure')
            ...
            <form method="POST" action="{{ route('achievement.update', ['article' => $article]) }}">
                ...
                <div class="form-body">
                    @include('error_card_list')
                    <label>失敗した原因</label>
                    <textarea name="cause" class="form-control my-2" rows="2" placeholder="原因"></textarea>
                    <label>次回の対策</label>
                    <textarea name="solution" class="form-control my-2" rows="2" placeholder="対策"></textarea>
