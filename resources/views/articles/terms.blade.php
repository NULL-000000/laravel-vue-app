    ...
    <div class="container" style="max-width: 900px;">
        <div class="card bg-paper p-2 my-4 small">
            <div class="card-body">
                ...
                <div class="card-text">
                    <p>
                        この利用規約（以下、「本規約」といいます。）は、TO DO SENGEN運営者（以下、「当社」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
                    </p>
                </div>
            </div>
